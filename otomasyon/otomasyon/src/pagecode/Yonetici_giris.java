 ...
 *
 */
public class Yonetici_giris extends PageCodeBase {
	...
	protected HtmlOutputLinkEx linkEx8;
	...
	protected HtmlOutputLinkEx getLinkEx8() {
		if (linkEx8 == null) {
			linkEx8 = (HtmlOutputLinkEx) findComponentInRoot("linkEx8");
		}
		return linkEx8;
	}
